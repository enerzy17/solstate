...
Generated **2026-09-23T13:41:37Z** in 12.0s across 15 HTTP calls.

> **Status:** 6 warning-level anomalies. Data completeness 100.0% (14/14 probes returned data). History depth: 157 prior runs.

## Anomalies

- [WARNING] **slot_time_ms** (statistical) - slot_time_ms is 6.7 robust deviations from its 157-point median of 315.8, a 15.9% move.
- [WARNING] **sol_ath_change_pct** (statistical) - sol_ath_change_pct is 3.6 robust deviations from its 157-point median of -65.25, a 7.8% move.
- [WARNING] **sol_fdv_usd** (statistical) - sol_fdv_usd is 3.6 robust deviations from its 157-point median of 6.462e+10, a 14.8% move.
- [WARNING] **sol_market_cap_usd** (statistical) - sol_market_cap_usd is 3.7 robust deviations from its 157-point median of 5.98e+10, a 14.9% move.
- [WARNING] **sol_price_usd** (statistical) - sol_price_usd is 3.6 robust deviations from its 157-point median of 101.9, a 14.7% move.
- [WARNING] **tvl_usd** (statistical) - tvl_usd is 5.1 robust deviations from its 157-point median of 5.863e+09, a 10.8% move.
...
| Epoch | 1,041 |
| Epoch progress | 1.84% |
| Epoch time remaining (est.) | 47h 7m |
| Absolute slot | 449,719,940 |
| Block height | 427,760,196 |
| TPS (all) | 4,406.42 |
| TPS (non-vote) | 1,875.80 |
| TPS (30-sample mean) | 4,389.80 |
| Slot time | 265.50 ms |
| Block lag vs wall clock | 10s |
| Lifetime transactions | 551,717,829,335 |
...
| Validators at 0% commission | 237 |
...
| `3PZSgErg4p6i...` | 36.93K | 449,713,930 |
...
| Chain fees 24h (REV proxy) | $17.78M |
