...
Generated **2026-08-17T20:46:41Z** in 9.1s across 15 HTTP calls.

> **Status:** 1 warning-level anomaly. Data completeness 100.0% (14/14 probes returned data). History depth: 105 prior runs.

## Anomalies

- [WARNING] **delinquent_pct_by_stake** (statistical) - delinquent_pct_by_stake is 5.1 robust deviations from its 105-point median of 0.0166, a 399.4% move.
...
| Health | ok |
| Epoch | 1,018 |
| Epoch progress | 33.64% |
| Epoch time remaining (est.) | 31h 51m |
| Absolute slot | 439,921,337 |
| Block height | 417,971,762 |
| TPS (all) | 4,249.80 |
| TPS (non-vote) | 2,616.45 |
| TPS (30-sample mean) | 4,208.89 |
| Slot time | 413.80 ms |
| Block lag vs wall clock | 15s |
| Lifetime transactions | 539,081,240,175 |
