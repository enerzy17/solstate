...
Generated **2026-09-04T00:08:51Z** in 12.2s across 15 HTTP calls.

> **Status:** 13 warning-level anomalies. Data completeness 100.0% (14/14 probes returned data). History depth: 245 prior runs.

## Anomalies

- [WARNING] **chain_fees_7d_usd** (statistical) - chain_fees_7d_usd is 3.9 robust deviations from its 245-point median of 6.639e+07, a 39.0% move.
- [WARNING] **delinquent_pct_by_count** (statistical) - delinquent_pct_by_count is 6.7 robust deviations from its 245-point median of 1.295, a 111.4% move.
- [WARNING] **dex_volume_7d_usd** (statistical) - dex_volume_7d_usd is 5.0 robust deviations from its 245-point median of 1.121e+10, a 50.3% move.
- [WARNING] **slot_time_ms** (statistical) - slot_time_ms is 4.6 robust deviations from its 245-point median of 411, a 24.0% move.
- [WARNING] **sol_ath_change_pct** (statistical) - sol_ath_change_pct is 8.3 robust deviations from its 245-point median of -73.66, a 12.3% move.
- [WARNING] **sol_change_30d_pct** (statistical) - sol_change_30d_pct is 5.2 robust deviations from its 245-point median of 1.76, a 2220.5% move.
- [WARNING] **sol_fdv_usd** (statistical) - sol_fdv_usd is 8.3 robust deviations from its 245-point median of 4.884e+10, a 34.6% move.
- [WARNING] **sol_market_cap_usd** (statistical) - sol_market_cap_usd is 8.3 robust deviations from its 245-point median of 4.502e+10, a 35.0% move.
- [WARNING] **sol_price_usd** (statistical) - sol_price_usd is 8.3 robust deviations from its 245-point median of 77.25, a 34.4% move.
- [WARNING] **tvl_change_24h_pct** (statistical) - tvl_change_24h_pct is 3.7 robust deviations from its 245-point median of 0.49, a 1051.0% move.
- [WARNING] **tvl_change_30d_pct** (statistical) - tvl_change_30d_pct is 4.9 robust deviations from its 245-point median of 0.69, a 3555.1% move.
- [WARNING] **tvl_usd** (statistical) - tvl_usd is 6.9 robust deviations from its 245-point median of 4.9e+09, a 21.8% move.
- [WARNING] **validators_delinquent** (statistical) - validators_delinquent is 6.7 robust deviations from its 245-point median of 9, a 111.1% move.
...
| Epoch | 1,028 |
| Epoch progress | 1.93% |
| Epoch time remaining (est.) | 47h 4m |
| Absolute slot | 444,104,342 |
| Block height | 422,150,840 |
| TPS (all) | 3,458.28 |
| TPS (non-vote) | 1,291.40 |
| TPS (30-sample mean) | 3,500.89 |
| Slot time | 312.50 ms |
| Block lag vs wall clock | 11s |
| Lifetime transactions | 544,929,842,000 |
...
| Total active stake | 436.90M SOL |
...
| --- | --- | --- | --- | --- |
| 1 | `Fd7btgySsrju...` | 17.39M | 3.98% | 7.00% |
| 2 | `HEL1USMZKAL2...` | 16.32M | 3.74% | 0.00% |
| 3 | `DRpbCBMxVnDK...` | 12.46M | 2.85% | 0.00% |
| 4 | `JUPiTERrZqgf...` | 11.38M | 2.60% | 5.00% |
| 5 | `E1r4Psq84tHf...` | 9.57M | 2.19% | 0.00% |
| 6 | `C8Bey3LKVJHV...` | 9.28M | 2.12% | 7.00% |
| 7 | `CAo1dCGYrB6N...` | 9.04M | 2.07% | 10.00% |
| 8 | `EvnRmnMrd69k...` | 7.38M | 1.69% | 7.00% |
| 9 | `9eGrDohdNTAo...` | 7.13M | 1.63% | 5.00% |
| 10 | `Awes4Tr6TX8J...` | 6.59M | 1.51% | 0.00% |
| 11 | `9jxgosAfHgHz...` | 6.12M | 1.40% | 100.00% |
| 12 | `JD549HsbJHeE...` | 6.12M | 1.40% | 0.00% |
| 13 | `5pPRHniefFjk...` | 5.96M | 1.36% | 5.00% |
| 14 | `5Cchr1XGEg7d...` | 5.63M | 1.29% | 100.00% |
| 15 | `GnC339vkyXRm...` | 4.84M | 1.11% | 7.00% |

### Largest delinquent validators

| Node | Stake (SOL) | Last vote |
| --- | --- | --- |
| `vahMVcSS3v6u...` | 163.34K | 444,087,651 |
| `xLabscif2DLn...` | 78.25K | 443,788,373 |
| `mrgn4atx3Jnf...` | 20.30K | 444,096,006 |
| `prt1st4RSxAt...` | 19.80K | 443,486,942 |
| `E4xNK4UwGnMt...` | 10.45K | 443,348,723 |
| `5ZjxMYBbnKd4...` | 4.06K | 443,965,922 |
| `FSyAsxcE7g8p...` | 3.02K | 442,786,121 |
| `Fb77sbwgXmtj...` | 2.13K | 444,096,006 |
...
| Circulating supply | 585.36M SOL |
