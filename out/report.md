...
Generated **2026-08-24T13:17:05Z** in 11.3s across 15 HTTP calls.

> **Status:** 14 warning-level anomalies. Data completeness 100.0% (14/14 probes returned data). History depth: 185 prior runs.

## Anomalies

- [WARNING] **chain_fees_7d_usd** (statistical) - chain_fees_7d_usd is 5.7 robust deviations from its 185-point median of 6.5e+07, a 27.3% move.
- [WARNING] **delinquent_pct_by_stake** (statistical) - delinquent_pct_by_stake is 6.4 robust deviations from its 185-point median of 0.0196, a 595.9% move.
- [WARNING] **dex_volume_7d_usd** (statistical) - dex_volume_7d_usd is 18.6 robust deviations from its 185-point median of 1.079e+10, a 79.4% move.
- [WARNING] **slot_time_ms** (statistical) - slot_time_ms is 5.8 robust deviations from its 185-point median of 413.8, a 12.1% move.
- [WARNING] **sol_ath_change_pct** (statistical) - sol_ath_change_pct is 14.9 robust deviations from its 185-point median of -73.97, a 9.2% move.
- [WARNING] **sol_change_30d_pct** (statistical) - sol_change_30d_pct is 8.8 robust deviations from its 185-point median of 0.45, a 6660.0% move.
- [WARNING] **sol_change_7d_pct** (statistical) - sol_change_7d_pct is 4.9 robust deviations from its 185-point median of 3.63, a 670.2% move.
- [WARNING] **sol_fdv_usd** (statistical) - sol_fdv_usd is 15.3 robust deviations from its 185-point median of 4.824e+10, a 26.4% move.
- [WARNING] **sol_market_cap_usd** (statistical) - sol_market_cap_usd is 15.7 robust deviations from its 185-point median of 4.445e+10, a 26.5% move.
- [WARNING] **sol_price_usd** (statistical) - sol_price_usd is 15.0 robust deviations from its 185-point median of 76.35, a 26.2% move.
- [WARNING] **sol_volume_24h_usd** (statistical) - sol_volume_24h_usd is 7.3 robust deviations from its 185-point median of 1.33e+09, a 226.2% move.
- [WARNING] **tvl_change_30d_pct** (statistical) - tvl_change_30d_pct is 5.7 robust deviations from its 185-point median of -0.08, a 19925.0% move.
- [WARNING] **tvl_change_7d_pct** (statistical) - tvl_change_7d_pct is 6.7 robust deviations from its 185-point median of 1.95, a 731.3% move.
- [WARNING] **tvl_usd** (statistical) - tvl_usd is 12.4 robust deviations from its 185-point median of 4.847e+09, a 14.5% move.
...
| Health | ok |
| Epoch | 1,021 |
| Epoch progress | 76.44% |
| Epoch time remaining (est.) | 11h 18m |
| Absolute slot | 441,402,235 |
| Block height | 419,451,223 |
| TPS (all) | 4,301.83 |
| TPS (non-vote) | 2,432.43 |
| TPS (30-sample mean) | 4,242.45 |
| Slot time | 363.60 ms |
| Block lag vs wall clock | 13s |
| Lifetime transactions | 541,349,527,572 |
...
| Active | 685 |
| Delinquent | 10 |
| Delinquent share of stake | 0.14% |
...
| --- | --- | --- |
| `84gC25fbFKYu...` | 517.47K | 441,397,680 |
...
| Chain fees 24h (REV proxy) | $12.56M |
